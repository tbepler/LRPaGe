 ...
 * 
 */
public class PseudonymKeywordToken
    extends Token<Visitor>
{


    public PseudonymKeywordToken(String text, int line, int pos) {
        super(text, line, pos);
    }

    public PseudonymKeywordToken() {
        super();
    }
    ...
    public Symbol symbol() {
        return Symbols.PSEUDONYMKEYWORD;
    }

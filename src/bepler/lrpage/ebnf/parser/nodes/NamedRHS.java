 ...
 * 
 */
public class NamedRHS
    extends RHSAbstractNode
{

    public final RHSAbstractNode rhs0;
    public final NameDeclAbstractNode namedecl1;

    public NamedRHS(RHSAbstractNode rhs0, NameDeclAbstractNode namedecl1) {
        this.rhs0 = rhs0;
        this.namedecl1 = namedecl1;
    }
    ...
    public int hashCode() {
        ...
        hash = ((hash* 13)+ namedecl1 .hashCode());
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NamedRHS)) {
            return false;
        }
        NamedRHS castResult = ((NamedRHS) o);
        if (!this.rhs0 .equals(castResult.rhs0)) {
            return false;
        }
        if (!this.namedecl1 .equals(castResult.namedecl1)) {
            return false;
        }
        return true;
    }
